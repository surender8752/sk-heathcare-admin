            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    <label htmlFor="doc-img">
                        <div className='w-16 h-16 bg-gray-100 rounded-full cursor-pointer flex items-center justify-center'>
                            {docImg ? <img className='w-full h-full object-cover rounded-full' src={URL.createObjectURL(docImg)} alt="" /> : <span className='text-3xl'>+</span>}
                        </div>
